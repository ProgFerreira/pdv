                ...
                ?>
                    <tr class="hover:bg-gray-50 transition-colors <?php echo $saleCancelled ? 'bg-red-50/50' : ''; ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2 flex-wrap gap-1">
                                <a href="?route=pos/receipt&id=<?php echo (int) $s['id']; ?>"
                                    target="_blank"
                                    class="inline-flex items-center gap-1 text-primary hover:opacity-90 bg-primary/10 px-2 py-1.5 rounded hover:bg-primary/20 transition-colors text-sm"
                                ...
                                <?php if (!$saleCancelled): ?>
                                    <a href="?route=sale/view&id=<?php echo $s['id']; ?>&whatsapp=1"
                                        class="inline-flex items-center gap-1 text-green-600 hover:text-green-900 bg-green-50 px-2 py-1.5 rounded hover:bg-green-100 transition-colors text-sm"
                                    ...
                                    <a href="?route=sale/open&id=<?php echo $s['id']; ?>"
                                        class="inline-flex items-center gap-1 text-green-600 hover:text-green-900 bg-green-50 px-2 py-1.5 rounded hover:bg-green-100 transition-colors text-sm"
                                        title="Abrir no PDV">
                                        <i class="fas fa-folder-open"></i><span>Abrir no PDV</span>
                                    </a>
                                    <?php if (hasPermission('sale_cancel')): ?>
                                        <a href="<?php echo htmlspecialchars(BASE_URL ?? '', ENT_QUOTES, 'UTF-8'); ?>?route=sale/cancel&id=<?php echo (int) $s['id']; ?>"
                                            ...
                                            class="inline-flex items-center gap-1 text-red-700 hover:text-red-900 bg-red-50 px-2 py-1.5 rounded hover:bg-red-100 transition-colors border border-red-200 text-sm"
                                            title="Cancelar venda">
                                            <i class="fas fa-times-circle"></i><span>Cancelar venda</span>
                                        </a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
