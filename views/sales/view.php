...
<div class="mt-6 flex flex-wrap items-center justify-end gap-3">
    <button type="button" id="btn-whatsapp-sale" data-sale-id="<?php echo (int) $sale['id']; ?>" data-whatsapp-text="<?php echo htmlspecialchars($whatsappText, ENT_QUOTES, 'UTF-8'); ?>" data-customer-phone="<?php echo htmlspecialchars($customerPhone, ENT_QUOTES, 'UTF-8'); ?>"
    ...
    <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <div class="mt-4 flex flex-wrap gap-2 justify-end items-center">
                ...
                <button type="button" id="modal-whatsapp-send" class="px-4 py-2 rounded-lg bg-green-500 text-white hover:bg-green-600 font-medium shrink-0 whitespace-nowrap">Abrir WhatsApp</button>
            </div>
        </div>
    </div>
</div>
...
(function() {
    ...
    sendBtn.addEventListener('click', function() {
        ...
        if (saleId && baseUrl) {
            var markUrl = baseUrl + '/?route=sale/markWhatsappSent&id=' + saleId;
            fetch(markUrl, { method: 'GET', credentials: 'same-origin' }).then(function() {
