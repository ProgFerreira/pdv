...
<head>
    ...
    <title>404 - <?php echo htmlspecialchars($title, ENT_QUOTES, 'UTF-8'); ?></title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
        <div class="text-6xl text-gray-400 mb-4"><i class="fas fa-search"></i></div>
        <h1 class="text-2xl font-bold text-gray-800 mb-2">404 - Página não encontrada</h1>
